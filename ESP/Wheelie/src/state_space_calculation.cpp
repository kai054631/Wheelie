...
Profile profile_list[] = {
    {25, -0.22f, -8.0f, -10.0f, 52.07f, 2.40f, 1.5f, 0.343f},
    {45, -0.14f, -8.0f, -12.0f, 56.60f, 2.4f, 1.5f, 0.343f},
    {65, -0.11f, -10.0f, -15.0f, 59.79f, 2.77f, 1.5f, 0.343f},
    {85, -0.08f, -8.0f, -13.0f, 61.00f, 4.00f, 1.5f, 0.343f},
};
